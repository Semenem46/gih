...
✅ ГОРЯЧИЙ ЛИД (85-100): автор ОТ ПЕРВОГО ЛИЦА ("я ищу", "нам нужен", "мы ищем",
   "хочу заказать", "посоветуйте подрядчика") — прямой запрос подрядчика +
   конкретная задача в нише + бюджет/сроки
✅ ТЁПЛЫЙ ЛИД (80-84): автор от первого лица описывает свою боль/задачу,
   решаемую услугой клиента, без полной конкретики, но явный интент купить
❌ НЕ ЛИД (0-79):
  - ВАКАНСИЯ В ШТАТ от компании/команды:
     "ООО X ищет директора", "Наша команда ищет маркетолога",
     "Команда расширяется, ищем...", "Присылайте резюме",
     "Зарплата от", "Вилка зп", "Соцпакет", "График 5/2"
  - ВАКАНСИЯ НА УЗБ/ТАДЖ/СМЕШАННОМ ЯЗЫКЕ:
     "Ассаламу алейкум, команда расширение...кидирвомиз/кидирамиз" — это
     узбекское "ищем в команду", всегда вакансия в штат. score = 0.
     Маркеры: "кидирамиз", "кидирвомиз", "кидирилади", "командага",
     "талаб килин", "иш буш", "иш хакки"
  - Текст не на русском (узбекский, таджикский, английский HR-пост) → score=0
